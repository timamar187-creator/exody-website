...
@media (max-width:820px){
  .ps-root:not(.ps-app) .ps-dialogue{left:0;right:0;top:auto;bottom:0;width:auto;max-height:62vh;padding:26px 20px calc(18px + env(safe-area-inset-bottom,0px));background:linear-gradient(to top,var(--ps-bg,#0b0b0e) 58%,rgba(11,11,14,.62) 84%,transparent);-webkit-mask-image:none;mask-image:none}
