...
@media (max-width:820px){
  .ps-root:not(.ps-app) .ps-dialogue{left:0;right:0;top:auto;bottom:0;width:auto;max-height:62vh;padding:26px 20px calc(52px + env(safe-area-inset-bottom,0px));background:linear-gradient(to top,rgba(5,5,7,.97) 66%,rgba(5,5,7,.74) 89%,transparent);-webkit-mask-image:none;mask-image:none}
